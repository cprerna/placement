...
export default function Topbar() {
  ...
  return (
    ...
    <div className="flex justify-between items-start bg-white m-3 px-8 py-5 my-5 rounded-2xl">
      {/* Left side: Info card */}
      ...
      <div className="relative">
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 w-48 bg-white border rounded-xl shadow-md z-10">
            ...
            <a href="/helpline"><button className="w-full text-left px-4 py-2 hover:bg-gray-100 flex items-center">
